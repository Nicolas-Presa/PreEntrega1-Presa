...
resultado = parseInt(prompt("elija sus hamburguesas indicando el numero correspondiente 1- Hamburguesa simple 2- Hamburguesa con queso cheddar 3- Hamburguesa con queso cheddar y bacon 4- Siguiente"));
    switch(resultado){
        case 1 : console.log(contador1+= hamburguesaSimple);
                    ...
                    alert("Quiere agregar otra hamburguesa? De haber finalizado su pedido marque el numero 4");
        break;
        ...
        break;
        default:
            alert("Seleccione una hamburguesa con su numero indicado");
            break;
    }
}
...
while(resultado != 3){
    resultado = parseInt(prompt("elija sus acompañamientos indicando el numero correspondiente 1- Papas Fritas 2- Ensalada 3- Siguiente"));
    switch(resultado){
        case 1 : console.log(contador2+= papasFritas);
                    alert("Usted eligio Papas Fritas $" + papasFritas);
                    alert("Quiere agregar otro acompañamiento? De haber finalizado marque el 3");
        break;
        ...
        break;
        default : 
        alert("Seleccione un acompañamiento con su numero indicado");
        break;
    }
}
...
while(resultado != 5){
    ...
    switch(resultado){
        case 1 : console.log(contador3+= agua);
                    ...
                    alert("Quiere agregar otra bebida? De haber finalizado marque el 5");
        break;
        ...
        break;
        default:
            alert("Seleccione una bebida con su numero indicado");
        break;
    }
}
...
if (metodoDePago == 1){
    alert("Su pedido sera entregado dentro de los proximos 40 minutos siendo abonado en puerta, Muchas gracias");
    console.log("$" + subtotal + " Paga en Puerta");
    ...
    pago = parseInt(prompt("ingrese su pago")); if(pago == subtotal){
        alert("Gracias por su compra su pedido sera entregado dentro de los proximos 40 minutos");
